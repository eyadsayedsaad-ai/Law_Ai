...
# --- [3] واجهة المنصة والشات والرد السريع التدريجي ---
    ...
    if chosen_package != "الخط السريع (المجاني) animate":
        if chosen_package != "الخط السريع (المجاني)":
            st.warning("💳 لتفعيل هذا الاشتراك المدفوع بشكل دائم، يرجى تحويل قيمة الاشتراك عبر فودافون كاش إلى الرقم (لا يوجد رقم الان ) وإرسال لقطة الشاشة للمراجعة وتفعيل الحساب.")
